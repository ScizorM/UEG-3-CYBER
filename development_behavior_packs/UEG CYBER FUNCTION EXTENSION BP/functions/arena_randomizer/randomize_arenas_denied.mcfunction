...
execute if score arena_slot_1 arena_randomizer matches 61 run function arena_randomizer/randomize_arenas_phase1
...
execute if score arena_slot_2 arena_randomizer matches 61 run function arena_randomizer/randomize_arenas_phase3
...
execute if score arena_slot_3 arena_randomizer matches 61 run function arena_randomizer/randomize_arenas_phase5
