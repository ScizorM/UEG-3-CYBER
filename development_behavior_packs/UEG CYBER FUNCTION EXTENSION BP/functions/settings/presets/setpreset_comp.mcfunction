...
scoreboard players set max_wins max_wins 2
scoreboard players set max_lives max_lives 2
...
scoreboard players set minimum_dash_requirement minimum_dash_requirement 2
scoreboard players set dash_strength dash_strength 1
scoreboard players set dash_verticality dash_verticality 1
tellraw @a {"rawtext": [{"text": "§e[Settings] §aPreset Selected: Competitive"}]}
