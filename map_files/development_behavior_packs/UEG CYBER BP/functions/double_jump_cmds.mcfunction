...
#execute @a[tag=!flying,tag=dash_enabled,m=!c,tag=ingame] ~ ~ ~ ability @s mayfly true
...
#execute @a[tag=!flying,tag=dash_enabled,m=!c,tag=mission] ~ ~ ~ ability @s mayfly true
...
#execute @a[tag=!flying,tag=dash_enabled,m=!c,tag=tutorial] ~ ~ ~ ability @s mayfly true
