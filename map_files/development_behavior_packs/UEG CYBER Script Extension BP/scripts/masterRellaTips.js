export {masterRellaTips, otherMasterRellaMessages }
...
const masterRellaTips = {
    ...
    secrets: [
        ...
        "§cI heard the word 'Burger' is used for a code somewhere?",
        "§cWhat're you talkin' about? I never said I would give you better advice just because you gave me money. Oh, wait... I did. Sorry. Better luck next time.",
        "§cSome rascal sent me a little voucher with some gibberish on it. I'd say you want it more than me, take a look. (It says 'r3llaCh22z1!' on it.)",
        "§cThere was a little robot running around the lobby with the text 'Il03vePizAA!!!' on it, not sure where it went though. Probably outta here by now.",
        "§cSorry youngun, I don't have anything to tell you right now. I'm keepin' that cash though."
